...
5. transfer4.php переносит разделы, блоки, уроки с домашними заданиями, тесты и вопросы в тестах, ограничения доступа. Нельзя запускать повторно без предварительной очистки курсов, иначе наплодит дубли!!
6. transfer5.php установить критерии завершения курса по всем модулям с контролем выполнения.
